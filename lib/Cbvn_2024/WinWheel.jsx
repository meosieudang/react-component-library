  ...
  constructor(options, drawWheel) {
    ...
    if (drawWheel == true) {
      ...
      for (let y = 1; y <= this.numSegments; y++) {
        if (
          this.segments[y].image !== null &&
          this.segments[y].imgData === null
        ) {
    ...
    if (this.animation) {
      ...
      if (this.animation.stopAngle == null) {
        ...
        this.animation._stopAngle =
          (360 - this.animation.stopAngle + this.pointerAngle) % 360;
      }
